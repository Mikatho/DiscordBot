...
public class googleCalendarManager {
    ...
    public String createCalendar() throws IOException {
        ...
        newcalendar.setSummary("calendarSummary");
        newcalendar.setTimeZone("America/Los_Angeles");

        // Insert the new calendar
        com.google.api.services.calendar.model.Calendar testCalendar = service.calendars().insert(newcalendar).execute();

        System.out.println(testCalendar.getId());
        return testCalendar.getId();
    }
}